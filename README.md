# Minnpost Minimum Wage Timeline
...
Data is coming from [this Google Spreasheet](https://docs.google.com/a/minnpost.com/spreadsheet/ccc?key=0AjYft7IGrHzNdFZTV0tHRGtEVWxrQXhRUGJ3emtoZmc).

## Data processing

*Data processing not necesary.*
...
1. Check out this code with [Git](http://git-scm.com/): `git clone https://github.com/MinnPost/minnpost-minimum-wage-timeline.git`
1. Go into the template directory: `cd minnpost-minimum-wage-timeline`
...
1. Run: `grunt server`
    * This will run a local webserver for development and you can view the application in your web browser at [http://localhost:8880](http://localhost:8880).
...
1. Run: `grunt deploy`
1. This will output a bit of HTML to embed in your article.
